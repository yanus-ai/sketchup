...
# Loader file for the YanusConnector plugin
...
module YanusConnector
  ...
  unless file_loaded?(__FILE__)
    ...
    extension.description = "Connects Yanus to Sketchup."
    extension.version     = PLUGIN_VERSION
    extension.copyright   = "©2025 Yanus"
    extension.creator     = "Yanus Group"
